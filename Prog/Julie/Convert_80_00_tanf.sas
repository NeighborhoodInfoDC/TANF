*  Program:  Convert_80_00.SAS - Census 2000 Tract Conversion
*  Library: TANF 
...
*  				Uses Geolytics-derived tract weights in file TWT80_00. 
				This program also sorts the data by the 2000 Census tract 
				and merges the different years (1998,1999,2000 and 2003 data)
*     			NB:  You must edit the PROGRAM PARAMETER DEFINITIONS below to specify
*       		the name of the input data set and variables you wish to convert.
...
title 'Convert_80_00:  Census 2000 Tract Conversion';


**** Data set names and locations ****;

** Input data set (source data --converting data set) **;
%let in_dat = TANF.TANF_2003_07_80tracts    ;
...
%let out_dat = TANF.TANF_2003_07_tr00 ;
...
%let out_lbl = TANF cases, 2003 July, tracts (2000);

**** Variables to be converted ****;
*insert  #4;
** Total Population Count variables **;
%let popvar =
    unborn_2003_07 infant_2003_07 todd_2003_07 preteen_2003_07 teen_2003_07 PI_2003_07 FULPART_2003_07
    No_kids_2003_07 adult_2003_07 hh_2003_07;
...
proc sort data=TANF.TANF_2003_07_tr00; 
	by geo00;
proc sort data=TANF.TANF_2002_07_tr00; 
	by geo00;
proc sort data=TANF.TANF_1998_tr00; 
	by geo00;
proc sort data=TANF.TANF_9907_tr00; 
	by geo00;
run;
data Issue_scan_04_health_jf_tr00; 
	merge TANF.TANF_1998_tr00 (keep=No_kids_1998_07 geo00 pi_1998_07)
			TANF.TANF_2003_07_tr00 (keep= No_kids_2003_07 PI_2003_07 geo00 hh_2003_07)
			TANF.TANF_2002_07_tr00 (keep= No_kids_2002_07 PI_2002_07 geo00 hh_2002_07)
			TANF.TANF_1999_07_tr00 (keep= No_kids_1999_07 PI_1999_07 geo00 hh_1999_07)
; 
by geo00;
run;
