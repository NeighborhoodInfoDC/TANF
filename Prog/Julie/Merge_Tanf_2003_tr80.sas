************************************************************************
* Program:  Merge_Tanf_2003_07_tr80.sas
* Library:  TANF
...
proc print data = aggr2003clie ;
	where PI_&year._&month. =1 and ADULT_&year._&month. = 0 and TEEN_&year._&month.=1 and (INFANT_&year._&month.=1 or TODD_&year._&month.=1);
