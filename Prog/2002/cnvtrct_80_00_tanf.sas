...
libname DC_TANF "d:\Metro\JFenders\Working TANF\2002" ;
libname CONVRT v8 "d:\Metro\JFenders\Working TANF\2002\sasprograms\TractConv" ;

**** Data set names and locations ****;

** Input data set (source data --converting data set) **;
%let in_dat = DC_TANF.TANF200207_80tracts    ;
...
%let out_dat = DC_TANF.TANF_0207_tr00 ;
...
%let out_lbl = TANF cases, 2002 July, tracts (2000);

**** Variables to be converted ****;
*insert  #4;
** Total Population Count variables **;
%let popvar =
    unborn_0207 infant_0207 todd_0207 preteen_0207 teen_0207 PI_0207 FULPART_0207
    No_kids_0207 adult_0207 hh_0207;
