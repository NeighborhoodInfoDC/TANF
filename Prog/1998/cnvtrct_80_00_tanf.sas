...
libname CONVRT v8 "d:\Metro\JFenders\Working TANF\1998\sasprograms\TractConv" ;

**** Data set names and locations ****;

** Input data set (source data --converting data set) **;
%let in_dat = DC_TANF.TANF199807_80tracts    ;
...
%let out_dat = DC_TANF.TANF_1998_tr00 ;
...
%let out_lbl = TANF cases, 1998 July, tracts (2000);

**** Variables to be converted ****;

** Total Population Count variables **;
%let popvar =
    unborn_9807 infant_9807 todd_9807 preteen_9807 teen_9807 PI_9807 FULPART_9807
    No_kids_9807 adult_9807;
