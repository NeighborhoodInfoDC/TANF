...
libname CONVRT v8 "d:\Metro\JFenders\Working TANF\2003\sasprograms\TractConv" ;

**** Data set names and locations ****;

** Input data set (source data --converting data set) **;
%let in_dat = DC_TANF.TANF200307_80tracts    ;
...
%let out_dat = DC_TANF.TANF_0307_tr00 ;
...
%let popvar =
    unborn_0307 infant_0307 todd_0307 preteen_0307 teen_0307 PI_0307 FULPART_0307
    No_kids_0307 adult_0307 hh_0307;
