*  Program:  CNVTRCT_80_00.SAS - Census 2000 Tract Conversion
*  Library: TANF 
...
libname CONVRT v8 "d:\Metro\JFenders\Working TANF\1999\sasprograms\TractConv" ;

**** Data set names and locations ****;

** Input data set (source data --converting data set) **;
%let in_dat = DC_TANF.TANF199907_80tracts    ;
...
%let out_dat = DC_TANF.TANF_9907_tr00 ;
...
%let out_lbl = TANF cases, 1999 July, tracts (2000);

**** Variables to be converted ****;
*insert  #4;
** Total Population Count variables **;
%let popvar =
    unborn_9907 infant_9907 todd_9907 preteen_9907 teen_9907 PI_9907 FULPART_9907
    No_kids_9907 adult_9907 hh_9907;
