************************************************************************
* Program:  Summarize_Tanf_2004_07.sas
* Library:  TANF
* Project:  DC Data Warehouse
* Authors:   Peter Tatian
* Created:  
* Version:  SAS 8.12
* Environment:  Windows
* Description:  This program creates summary TANF indicators for all
				standard levels
* Modifications: 10/04 by JF
*
**********************************************************************; 
